...
class ScoresControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create score" do
    assert_difference('Score.count') do
      post scores_url, params: { score: { game: @score.game, name: @score.name, score: @score.score } }
    end
  ...
  test "should update score" do
    patch score_url(@score), params: { score: { game: @score.game, name: @score.name, score: @score.score } }
